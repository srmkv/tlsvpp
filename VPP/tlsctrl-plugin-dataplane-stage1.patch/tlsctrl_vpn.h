...
typedef struct
{
  ...
  u16 mss_clamp;
  u8 running;
  tlsctrl_vpn_queued_frame_t *txq;
  tlsctrl_vpn_queued_frame_t *rxq;
...
int tlsctrl_vpn_transport_enqueue_tx_frame (u64 tunnel_id, u8 *frame);
int tlsctrl_vpn_transport_enqueue_rx_frame (u64 tunnel_id, u8 *frame);
int tlsctrl_vpn_transport_dequeue_tx_frame (u64 tunnel_id, u8 **out_frame);
int tlsctrl_vpn_transport_dequeue_rx_frame (u64 tunnel_id, u8 **out_frame);
void tlsctrl_vpn_transport_flush_queues (u64 tunnel_id);
